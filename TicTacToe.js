...
makeBoard() methods (these have to go at the start so that a makeBoard() object can be declared)
global variables
...
var makeBoard = new Function(); // Initializes object properties, used as a cunstructor.
...
updateNumberOfGames = function()
{
    ...
    if(numberOfGames<=0)
    {
        alert("Error. Number of games cannot be less that one.");
        numberOfGames=1;
...
levelSelect = function()
{
    ...
    (document.getElementById("watchCvC")).style.display="none";
...
mainMenu = function()
{
    ...
    (document.getElementById("difficultySelect2")).style.display="none";
    (document.getElementById("intervalSelect")).style.display="none";
    (document.getElementById("numberOfGamesSelect")).style.display="none";
    (document.getElementById("start")).style.display="none";
    (document.getElementById("reset")).style.display="none";
    (document.getElementById("difficultySelectText")).style.display="none";
    (document.getElementById("difficultySelectText2")).style.display="none";
    for(i=0; i<levelButtons.length; i++)
    {
